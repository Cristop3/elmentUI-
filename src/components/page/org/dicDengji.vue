    ...
    <div>
        ...
        <div class="container">
            <el-row  :gutter='4' style='margin-bottom:20px'>
                <el-col :span='4'>
                    <el-input placeholder="等级名称"  clearable v-model="form.name1">
                    </el-input>
                </el-col>
                <!--<el-col :span='4'>
                    <el-input placeholder="字典类型"  clearable v-model="form.name1">
                    </el-input>
                </el-col>-->
                <el-col :span='4'>
              ...
              <el-table :data="tableData" style="width: 100%" border center>
                    <el-table-column prop="F_A" label="等级名称" align="center">
                    </el-table-column>
        ...
        <!-- 修改岗位字典 -->
        <el-dialog width='25%' title='修改等级'   :visible.sync='dlgEdit' >
        ...
        <el-dialog width='40%'  title='授权'   :visible.sync='dlgMenu'>
            ...
            <div slot="footer" class="dialog-footer">
                <el-button type="primary" @click=""   size="small">授权</el-button>
            </div>
        </el-dialog>-->

        <!-- 新增岗位字典 -->
        <el-dialog width='25%' title='新增等级'  :visible.sync='dlgNew' >
            <el-form  :label-position="labelPosition" label-width="60px" >
                <el-form-item label='名称'>
